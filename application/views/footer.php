...
<script src="https://cdn.jsdelivr.net/gh/emn178/chartjs-plugin-labels/src/chartjs-plugin-labels.js"></script>
  ...
  <script>
    var data;
    $.ajax({
      url: '<?= base_url() ?>assets/js/visualisasi/olahan.json',
      async: false,
      dataType: 'json',
    ...
    function assignVariable(context) {
      data = context;
    }
  ...
  <!-- Bangs JS -->
  <script src="<?= base_url()?>assets/js/visualisasi/bangs.js"></script>
  <!-- Visualisasi JS -->
  <script src="<?= base_url()?>assets/js/visualisasi/visualisasi.js"></script>

  <!-- Maps -->
  <script src="<?= base_url()?>assets/js/map/map.js"></script>
